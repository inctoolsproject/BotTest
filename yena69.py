...
cl = LINETCR.LINE()
cl.login(token="En1Lx8HOyT2m0b0zsKw9.3UrGMEjECFh9gbFk6EFekq.7mGqKLj0rFHhTFvk4WANcJtFJDsei2z8nTy2mjjEB2E=")
cl.loginResult()
...
kd = LINETCR.LINE()
kd.login(token="EnDFtLqJwpvQT8xzm438.usk2DxruRb2/eg2IYrqXsa.xk9VhcVJXfbU38mHP4irfyPPNYcz2EUSDcrmm5LCsMk=")
kd.loginResult()

ke = LINETCR.LINE()
ke.login(token="EnZ3127Fo9nxnuLfMTh6.xkaL7HAdfdzB4bRIIC04jG.lTxOUg6olV7pmiEut5211sCHRXzMqA8veNi+TbDRmrE=")
ke.loginResult()

kf = LINETCR.LINE()
kf.login(token="EnAfJjbNZU8YPb5h75Xc.aYbkAqXV5gf9Eu4MbqlVBa.TBtxpbmzrr8Qo5kWVN4NWe1ji2tw9Z9inm78hsbmtvg=")
kf.loginResult()
...
kq = LINETCR.LINE()
kq.login(token="EnHXL1elJmw8t9gS1Xsa.am5VEhHU3Oh3X2olVwx66G.QrEZ1jiUjeYGG6OMCKtyvUStB5Yz5WjOxdabIssk044=")
kq.loginResult()
...
ks = LINETCR.LINE()
ks.login(token="EnqHGRxe3U25dbIzjXKc.cTXHQLZwcjas2Whcxxlhda.E6aXnWOrWSv07W899+aqCpq2Q5kcegaRlxvIglEwtsM=")
ks.loginResult()
